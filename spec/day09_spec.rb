...
describe 'day09' do
  ...
  describe 'part1' do
    describe 'official examples' do
      Dir.glob("#{dir}/day09_part1_example*").each do |input_file|
        example_id = $1 if input_file =~ /example(.+)$/
        expected_output_file = "#{dir}/day09_part1_expected#{example_id}"
        ...
        describe File.basename(input_file) do
          custom_it "solves example #{example_id}" do
            solver = Day09.new(File.read(input_file))
    ...
    describe 'my input' do
      input_file = "#{dir}/day09_part1_myinput"
      expected_output_file = "#{dir}/day09_part1_myoutput"
      expected_output = File.read(expected_output_file).to_i
  ...
  describe 'part2' do
    describe 'official examples' do
      Dir.glob("#{dir}/day09_part2_example*").each do |input_file|
        example_id = $1 if input_file =~ /example(.+)$/
        expected_output_file = "#{dir}/day09_part2_expected#{example_id}"
    ...
    describe 'my input' do
      input_file = "#{dir}/day09_part2_myinput"
      expected_output_file = "#{dir}/day09_part2_myoutput"
      expected_output = File.read(expected_output_file).to_i
