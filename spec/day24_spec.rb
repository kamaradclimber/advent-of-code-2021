...
describe 'day24' do
  ...
  describe 'part1' do
    describe 'official examples' do
      Dir.glob("#{dir}/day24_example*").each do |input_file|
        example_id = $1 if input_file =~ /example(\d+)$/
        expected_output_file = "#{dir}/day24_expected#{example_id}_part1"
    ...
    describe 'my input' do
      input_file = "#{dir}/day24_myinput"
      expected_output_file = "#{dir}/day24_myoutput_part1"
      expected_output = File.read(expected_output_file).to_i
  ...
  describe 'part2' do
    describe 'official examples' do
      Dir.glob("#{dir}/day24_example*").each do |input_file|
        example_id = $1 if input_file =~ /example(\d+)$/
        expected_output_file = "#{dir}/day24_expected#{example_id}_part2"
    ...
    describe 'my input' do
      input_file = "#{dir}/day24_myinput"
      expected_output_file = "#{dir}/day24_myoutput_part2"
      expected_output = File.read(expected_output_file).to_i
